...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-d7ae1850.js",
      css: ["/./_app/assets/start-0826e215.css"],
      js: ["/./_app/start-d7ae1850.js", "/./_app/chunks/vendor-fb03f8c7.js"]
    },
    fetched: void 0,
    floc: false,
...
var manifest = {
  ...
  routes: [
    ...
    },
    {
      ...
      pattern: /^\/landing\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/landing.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
...
var module_lookup = {
  ...
  "src/routes/landing.svelte": () => Promise.resolve().then(function() {
    return landing;
  }),
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "/./_app/pages/__layout.svelte-6e847a6c.js", "css": ["/./_app/assets/pages/__layout.svelte-66f554d2.css"], "js": ["/./_app/pages/__layout.svelte-6e847a6c.js", "/./_app/chunks/vendor-fb03f8c7.js"], "styles": null }, ".svelte-kit/build/components/error.svelte": { "entry": "/./_app/error.svelte-0d23c5a3.js", "css": [], "js": ["/./_app/error.svelte-0d23c5a3.js", "/./_app/chunks/vendor-fb03f8c7.js"], "styles": null }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-355c3dc6.js", "css": [], "js": ["/./_app/pages/index.svelte-355c3dc6.js", "/./_app/chunks/vendor-fb03f8c7.js", "/./_app/chunks/Icon-3aea3974.js"], "styles": null }, "src/routes/landing.svelte": { "entry": "/./_app/pages/landing.svelte-859405f5.js", "css": [], "js": ["/./_app/pages/landing.svelte-859405f5.js", "/./_app/chunks/vendor-fb03f8c7.js", "/./_app/chunks/Icon-3aea3974.js"], "styles": null }, "src/routes/second.svelte": { "entry": "/./_app/pages/second.svelte-d00e12a5.js", "css": [], "js": ["/./_app/pages/second.svelte-d00e12a5.js", "/./_app/chunks/vendor-fb03f8c7.js"], "styles": null } };
...
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <div class="${"px-3 py-2 bg-gray-800 h-screen flex flex-col items-center justify-between"}"><div class="${"flex flex-col items-center"}">
      <div class="${"my-1.5 w-12 h-12 rounded-full flex items-center justify-center"}" style="${"background: url('https://cdn.discordapp.com/banners/155749532615966720/cac172ea1db4be9f83dfc7232062e944.png?size=512'); background-position: center; background-size: cover;"}"></div>
...
var Landing = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let testData = [];
  onMount(() => {
    axios.get(`https://furrynetwork.com/api/search/artwork/popular?size=56&&from=0`).then((response) => {
  ...
  return `
<section class="${"bg-gray-800 overflow-hidden overflow-y-auto w-full h-screen flex justify-center items-center px-8"}">
...
<section class="${"bg-gray-800 w-full h-screen flex justify-center items-center"}"></section>`;
});
...
<div class="${"w-full pt-4 pb-2 px-4 relative flex flex-col"}">
  <div><h1 class="${"text-xl text-white font-bold"}">\u041A\u043B\u0443\u0431 \u0413\u0430\u0440\u0440\u0438 \u041F\u043E\u0442\u0442\u0435\u0440\u0430</h1>

    <div class="${"cursor-pointer flex items-center mt-0.5"}">${validate_component(Icon, "Icon").$$render($$result, {
    name: "external-link",
    attrs: { class: "w-4 h-4 text-white mr-1.5" }
  }, {}, {})}
      <p class="${"text-sm text-white opacity-60"}">&quot;\u0413\u0430\u0440\u0440\u0438 \u041F\u043E\u0442\u0442\u0435\u0440&quot;</p></div></div></div>
...
<div class="${"mb-2 px-4"}">
  <div class="${"my-4 flex items-center"}">
    ...
    <p class="${"ml-2 text-white font-medium"}">\u041F\u043E\u0438\u0441\u043A</p></div>
  ...
  <div class="${"my-4 flex items-center"}">
    ...
    <p class="${"ml-2 text-white font-medium"}">\u041A \u0440\u0430\u0441\u0441\u043A\u0430\u0437\u0443</p></div></div>


<div class="${"px-4 w-full relative"}"><div style="${"height: 3px;"}" class="${"w-full bg-gray-500 opacity-20 rounded-full"}"></div></div>
...
<div class="${"mt-2 px-2 flex-grow"}">
  <div class="${"my-2 w-full flex items-center relative rounded-xl py-2 px-2 bg-gray-500 bg-opacity-30"}">
    <div class="${"flex items-center w-2/3"}">
      ...
      <p class="${"text-md text-white font-medium"}">\u0413\u043B\u0430\u0432\u043D\u044B\u0439</p></div>

    
    <div class="${"w-1/3 items-center flex justify-end"}"><div class="${"w-6 h-6 bg-gray-800 rounded-full flex items-center justify-center"}"><p class="${"text-sm text-white font-medium"}">1</p></div></div></div>
  ...
  <div class="${"my-2 w-full flex items-center relative rounded-xl py-2 px-2"}">
    <div class="${"flex items-center w-2/3"}">
      ...
      <p class="${"text-md text-white font-medium"}">\u0427\u0430\u0435\u043F\u0438\u0442\u0438\u0435</p></div></div>
