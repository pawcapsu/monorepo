...
export class UniversalTextResolver {
  constructor(private readonly textService: UniversalTextService) {}
  ...
  async addTextNode(
    ...
    @Args("options", { nullable: true, description: "Different options" })
  ...
  async resolveNodes(@Parent() text: UniversalText) {
    return text.nodes;
  }
}
