...
import { ExploreBadge, PaginatedExploreBadges, UniversalText } from '@pawcapsu/types/models';
import { ExploreBadgeService } from '@pawcapsu/modules/explore/services';
import { UniversalTextService } from '@pawcapsu/modules/text/services';
import { ObjectId } from 'mongoose';
import { ExploreBadgesSearchOptionsInput } from '@pawcapsu/types/dto/explore/Badges';
