...
import { Book, BookDocument } from "@pawcapsu/types/models";
...
export class BooksService {
  constructor(
    @InjectModel("book")
    private readonly bookModel: PaginateModel<BookDocument>,
  ...
  // fetchDescription
  async fetchDescription(book: Book) {
  ...
  private _buildFindOptions(
    options: BookSearchOptions
  ): mongoose.FilterQuery<BookDocument> {
    return {};
  }
}
