import { BookTagInformation, ETagType, TagFilterOptions, TTagEntity } from '@app/shared';
...
import { BookDocument, BookTag, Profile, Tag, TagDocument } from '@pawcapsu/types/models';
      ...
      if (book) {
        ...
        if (tag) {
          if (this.permissionsService._checkWritePermissions(user._id, book)) {
            ...
            await this.bookModel.updateOne({ _id: book._id }, { tags: book.tags });
